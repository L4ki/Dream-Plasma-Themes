        ...
        ComboBox {
            ...
            delegate: ItemDelegate {
                ...
                contentItem: Text {
                    ...
                    color: selectUser.highlightedIndex === index ? root.palette.highlight.hslLightness >= 0.7 ? "#26324d" : "white" : root.palette.window.hslLightness >= 0.8 ? root.palette.highlight.hslLightness >= 0.8 ? "#26324d" : root.palette.highlight : "black"
